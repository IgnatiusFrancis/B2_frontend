...
import AllSeriesMovies from "@/components/AllSeriesMovies";

export default async function AllSeries() {
  const allMovies = await fetchMovies(1, 300, "SERIES");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <UseSearchMovies
        data={series}
        ContentContainer={AllSeriesMovies}
        searchFields={["title"]}
      />
    </div>
  );
