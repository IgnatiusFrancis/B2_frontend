...
import AllSeasonalMovies from "@/components/AllSeasonalMovies";

export default async function AllSeasonals() {
  const allMovies = await fetchMovies(1, 300, "SEASONAL");
  const series = allMovies.SEASONAL;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <UseSearchMovies
        data={series}
        ContentContainer={AllSeasonalMovies}
        searchFields={["title"]}
      />
    </div>
  );
