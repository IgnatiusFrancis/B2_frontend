    ...
    <>
      ...
      <section className="w-full max-w-7xl mx-auto p-4 flex flex-col md:flex-row gap-10">
        ...
        <div className="flex-1">
          {/* Blog Content Card */}
          <article className="bg-white rounded-xl shadow-lg p-6 space-y-8 transition-transform hover:scale-[1.02]">
            {/* Blog Title */}
            <header>
              <h1 className="text-4xl font-extrabold text-gray-900 hover:text-primarycolor transition-all">
                {post?.title}
              </h1>
