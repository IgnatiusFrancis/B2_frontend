...
function AddMovies() {
  ...
  // Previous validation functions and handlers remain the same...
  // Keeping all the existing functions but adding new ones below

  const showSeasonFields =
    movieData.type === "SEASONAL" || movieData.type === "SERIES";
  const showEpisodeFields = movieData.type === "SERIES";
