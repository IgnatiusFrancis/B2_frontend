      ...
      <form onSubmit={onSubmit} className="space-y-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
          <div className="mb-6">
            ...
            <input
              value={singleVideo.title}
              onChange={(e) => setSingleVideo({ ...singleVideo, title: e.target.value })}
              type="text"
              name="title"
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <input
                name="subTitle"
                value={singleVideo.subTitle}
                onChange={(e) => setSingleVideo({ ...singleVideo, subTitle: e.target.value })}
                type="text"
            ...
            <div>
              ...
              <input
                value={singleVideo.duration}
                name="duration"
                onChange={(e) => setSingleVideo({ ...singleVideo, duration: e.target.value })}
                type="text"
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              ...
              <select
                ...
                onChange={(e) => setSingleVideo({ ...singleVideo, artistId: e.target.value })}
              >
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
              ...
              <label htmlFor="video-upload" className="cursor-pointer">
                <div className="flex flex-col items-center py-8">
                  <Video className={`w-12 h-12 mb-2 ${file ? 'text-blue-500' : 'text-gray-400'}`} />
        ...
        {/* Description Section */}
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
          <label className="block text-sm font-medium mb-4">Video Description</label>
          <Tiptap
            content={singleVideo.description}
            onChange={(newContent) => handleContentChange(newContent)}
          />
