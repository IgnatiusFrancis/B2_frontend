...
//             <div className="bg-gray-800/40 backdrop-blur-lg rounded-2xl p-6 shadow-xl">
//               {/* Song Header */}
...
//                     className="p-4 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-all transform hover:scale-105 shadow-lg"
//                   >
...
//                     <FaHeart size={24} />
//                   </button>
//                   <button className="p-4 bg-gray-700 text-gray-300 rounded-full hover:bg-gray-600 transition-all transform hover:scale-105">
//                     <FaShare size={24} />
//                   </button>
//                 </div>
...
//                   className="inline-flex items-center px-6 py-3 bg-green-500 text-white rounded-xl hover:bg-green-600 transition-all transform hover:scale-105 shadow-lg"
//                 >
...
//             <div className="bg-gray-800/40 backdrop-blur-lg rounded-2xl p-6 shadow-xl sticky top-4">
            ...
            <div className="bg-gray-800/40 backdrop-blur-lg rounded-2xl p-4 md:p-6 shadow-xl">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-4 text-sm text-gray-400">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="truncate">{audio.genre}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="flex items-center gap-3 md:gap-4 justify-center md:justify-start">
                  <button
                    onClick={handlePlayPause}
                    className="p-3 md:p-4 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-all transform hover:scale-105 shadow-lg"
                  >
