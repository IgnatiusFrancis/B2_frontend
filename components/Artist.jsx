    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className={`${
              showDetails ? "top-0" : "top-[80%]"
            } bg-[#3f254c60] flex justify-between items-center p-4  transition-all duration-500 absolute left-0 right-0 bottom-0 border-b-2 border-primarycolor`}
          >
            <div>
